          ...
          <div className="w-full">
            ...
            <div className="flex justify-center items-center mb-10">
              <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                ...
                {hasPersonalKey && (
                  <span className="ml-1 inline-flex items-center px-1.5 py-0.5 rounded-full text-xs bg-purple-200 text-purple-800">
                    개인 키
                  </span>
                )}
                {!hasPersonalKey && (
                  <span className="ml-1 inline-flex items-center px-1.5 py-0.5 rounded-full text-xs bg-blue-200 text-blue-800">
                    기본 키
                  </span>
                )}
              </span>
