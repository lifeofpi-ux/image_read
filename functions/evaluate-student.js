      ...
      'https://api.openai.com/v1/chat/completions',
      {
        ...
        messages: [
          ...
          },
          {
            ...
            7. #평가문장 예시 부분의 문장들처럼 보임. 씀. ~음. ~함. ~됨. 등의 자연스러운 형태로 문장이 끝나야 하며, 한국어 문장 구조에 맞는 자연스러운 문장을 작성해줘.
 
            #평가문장 기본 생성원칙
            ***모든 영역에서 '우수'를 받은 학생의 경우, 잘하는 부분을 칭찬하는 긍정적인 성찰의 내용도 한문장 정도 함께 반영해줘. 전 영역이 우수할 경우 '우수함., 돋보임., 잘 설명함.' 등의 표현을 무작위로 섞어서 사용해줘.
