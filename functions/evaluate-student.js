      ...
      'https://api.openai.com/v1/chat/completions',
      {
        ...
        messages: [
          ...
          },
          {
            ...
            ***우수한 학생의 경우, 잘하는 부분을 칭찬하는 긍정적인 성찰의 내용도 한문장 정도 함께 반영해줘. 전 영역이 우수할 경우 {우수함, 뛰어남, 양호함, 돋보임} 등과 같은 표현을 다양하게 섞어서 사용해줘.
            ***평가 영역 점수가 보통인 경우 (같은 작품에 대한 생각이나 느낌이 서로 다를 수 있다는 것을 이해하고 자신의 생각이나 느낌을 다양한 방법으로 표현함.)와 같은 일반적인 수행에 대한 문장으로 표현해줘.     
            ***특정 영역에 보완이 필요한 학생의 경우, 부족한 부분에 대한 내용을 보충하여 (~한다면, 더 나은 발전이 있을 것으로 기대됨.) 등과 같은 앞으로의 발전을 위한 피드백 문장을 추가해줘. 
            ***모든 평가 요소에 대한 문장을 만들 필요는 없어. 필요하다면 일부 문장은 생략해줘.
