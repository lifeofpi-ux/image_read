      ...
      'https://api.openai.com/v1/chat/completions',
      {
        ...
        messages: [
          ...
          },
          {
            ...
            ***우수한 학생의 경우, 잘하는 부분을 칭찬하는 긍정적인 성찰의 내용도 한문장 정도 함께 반영해줘. 전 영역이 우수할 경우 {우수함, 뛰어남, 양호함, 돋보임} 등과 같은 표현을 골고루 섞어서 사용해줘.
            ***특정 영역에 보완이 필요한 학생의 경우, (~한다면, 더 나은 발전이 있을 것으로 기대됨.) 등과 같은 맥락의 문장을 추가해줘. 
            ***모든 평가 요소에 대한 문장을 만들 필요는 없어. 
            ***평가의 종합결과를 정리할 때 {전반적으로}라는 말이 너무 자주 쓰이지 않도록 해줘. 
