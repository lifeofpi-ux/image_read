      ...
      'https://api.openai.com/v1/chat/completions',
      {
        ...
        messages: [
          ...
          },
          {
            ...
            ***전반적으로 많은 영역의 점수가 낮은 학생의 경우, "부족함", "능력이 모자람" 등 부정적인 표현이 직접적으로 사용되지 않도록 해줘. 가능한 한 긍정표현을 사용하고 부족한 부분에 대한 내용을 보충하여 (~한다면, 더 나은 발전이 있을 것으로 기대됨.) 등과 같은 앞으로의 발전을 위한 피드백 문장을 추가해줘. 
