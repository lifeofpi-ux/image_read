      ...
      'https://api.openai.com/v1/chat/completions',
      {
        ...
        messages: [
          ...
          },
          {
            role: "user",
            content: `
            학생이름은 {김,이,최,백,우,유,윤,박,노,강} 등의 단어로 시작하는 3글자 가량의 독립된 문자열입니다. 
            또한 이름은 {번호} {이름} {평가점수} 형태의 텍스트 구조에 포함되어 있어서 찾기가 쉽습니다.
            텍스트 중 학생 목록에서 한글로 된 정상적인 학생 이름을 파악하여, 정확한 전체 학생 수를 추출하여 JSON 형식으로 반환해주세요. 
